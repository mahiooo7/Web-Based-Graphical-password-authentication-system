	...
	<div id="menu" class="container">
		<ul>
			...
			<li><a href="ViewProfile.jsp" accesskey="1" title="">View Profile</a></li>
                        ...
                        <li  class="current_page_item"><a href="TransferFound.jsp" accesskey="1" title="">Transfer Founds</a></li>
...
<div id="page" class="container">
	<div id="content">
		<div class="title">
                    ...
                    <form action="TFAction.jsp" method="post">
                    <table>
                        <tr><th>ID</th><td><input type="text" name="id" value="<%=id%>"></td></tr>
                        <tr><th>SELECT SEND TO</th><td><select name="senderid" style="width:175px;">
                                    <option>--select--</option>
                                
                        <%
                        ResultSet r=Queries.getExecuteQuery("select * from ureg where id!='"+id+"'");
                        while(r.next()){
                        %>
                        <option value="<%=r.getString("id")%>"><%=r.getString("id")%></option>     
                        <%
                    ...
                    <tr><th></th><td><input type="submit" value="Send Fund"/></td></tr>
